...
void			RobotPlayer::doUpdate(float dt)
{
    ...
    // Fire shot if possible
    aicore::DecisionTreeNode *node = aicore::DecisionTrees::shotDecisions[0].makeDecision(this, dt);
    (this->*(((aicore::ActionPtr*)node)->actFuncPtr))(dt);

    // Find drop flag decision
    aicore::DecisionTreeNode *node2 = aicore::DecisionTrees::dropFlagDecision[0].makeDecision(this, dt);
...
/* Decision Tree function definitions */

// Decisions

/*
 * Function Name: beingShotAt
 * Desc: Determines if current tank is being shot at.
 * Params: dt - game time
 * Return: bool
 */
bool        RobotPlayer::beingShotAt(float dt)
{
...
/*
 * Function Name: isBotHoldingFlag
 * Desc: checks if current bot is holding a flag.
 * Params: dt - game time
 * Return: bool
 */
bool RobotPlayer::isBotHoldingFlag(float dt)
{
...
/*
 * Function Name: isStickyFlag
 * Desc: checks if flag held by current bot is a sticky flag.
 * Params: dt - game time
 * Return: bool
 */
bool RobotPlayer::isStickyFlag(float dt)
{
    FlagType* myFlag = getFlag();
...
/*
 * Function Name: isTeamFlag
 * Desc: check if flag is part of a team.
 * Params: dt - game time
 * Return: bool
 */
...
/*
 * Function Name: isMyTeamFlag
 * Desc: checks if flag is current bot flag.
 * Params: dt - game time
 * Return: bool
 */
...
/*
 * Function Name: isFiringStatusReady
 * Desc: checks if firing status is ready.
 * Params: dt - game time
 * Return: bool
 */
...
/*
 * Function Name: isTimerReady
 * Desc: check if firing timer is ready.
 * Params: dt - game time
 * Return: bool
 */
bool RobotPlayer::isTimerReady(float dt)
{
    timerForShot -= dt;
...
/*
 * Function Name: willShotMiss
 * Desc: check if shot will miss by half a tank length.
 * Params: dt - game time
 * Return: bool
 */
bool RobotPlayer::willShotNotMiss(float dt)
{
    ...
    // only shoot if we miss by less than half a tanklength
...
/*
 * Function Name: isBuildingInWay
 * Desc: checks if building in way of shot.
 * Params: dt - game time
 * Return: bool
 */
bool RobotPlayer::isBuildingsInWay(float dt)
{
    float tankRadius = BZDBCache::tankRadius;
    float p1[3];
    getProjectedPosition(target, p1);
...
/*
 * Function Name: isTeammatesInWay
 * Desc: checks if shot is in way of teammates.
 * Params: dt - game time
 * Return: bool
 */
bool RobotPlayer::isTeammatesInWay(float dt)
{
...
/*
 * Function Name: resetShotTimer
 * Desc: resets shot timer.
 * Params: dt - game time
 * Return: void
 */
...
/*
 * Function Name: fireShot
 * Desc: fires current bot gun and resets shot timer.
 * Params: dt - game time
 * Return: void
 */
...
/*
 * Function Name: dropFlag
 * Desc: drops a flag that the current bot is holding. 
 * Params: dt - game time
 * Return: void
 */
 ...
 * Desc: part of the tree to do nothing.
 * Params: dt - game time
 * Return: void
 */
...
/*
 * Function Name: evade
 * Desc: evades bullets being shot at current tank. 
...
/*
 * Function Name: followPath
 * Desc: Follows the path made by A* algorithm.
 * Params: dt - game time
 * Return: void
 */
